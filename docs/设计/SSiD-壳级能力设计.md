...
> **核心原则（2026-08-16 定）**：SSiD 来做「DSH + 插件解决不了的事」，方案灵活，**100% 控制权**。SSiD 壳是自己写的 Electron 应用，站在「宿主应用」层而非「插件」层，所以它的能力边界不是一份固定清单，而是「Electron 主进程能做什么，壳就能做什么」——下面的能力只是**已知需要的实例**，不是全部，缺什么随时补。
