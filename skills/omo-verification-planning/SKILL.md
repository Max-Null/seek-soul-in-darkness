---
name: omo-verification-planning
description: 验证计划——编码前制定项目专属的证据路径。适用于功能开发、bug修复、重构、跨系统变更等需要可信验证的非平凡编码工作。Verification planning for non-trivial coding work that needs a credible project-specific evidence path.
---
...
external service, or rapidly changing capability, do focused research via web search
