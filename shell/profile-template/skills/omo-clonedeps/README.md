...
Cloned repositories live under `.dsh/clonedeps/repos/<safe-repo-name>/`, one
folder per source repository, and are ignored by git. `.dsh/clonedeps.json` is
...
If `.dsh/clonedeps.json` already exists, read it first and reuse those clones
