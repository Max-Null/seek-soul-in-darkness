...
//#region ../dsh-chat-rail/node_modules/.pnpm/@deepseek-ai+cosmokit@1.8.3/node_modules/@deepseek-ai/cosmokit/lib/index.js
...
//#endregion
//#region ../dsh-chat-rail/node_modules/.pnpm/@deepseek-ai+schemastery@3.18.2/node_modules/@deepseek-ai/schemastery/lib/index.mjs
...
const Config = Schema.object({
	hideWindow: Schema.boolean().default(true),
	hotkey: Schema.string().default("Control+Shift+A")
});
...
function apply(ctx) {
	...
	ctx.inject(["settings"], (settingsCtx) => {
		settingsCtx.settings.installSection(ctx, CAPTURE_NS, Config, readConfig(), {
			setSource: (next) => {
				writeConfig(next);
			},
			onChange: () => {}
