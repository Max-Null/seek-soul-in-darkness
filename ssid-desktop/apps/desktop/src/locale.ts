...
export const en = {
  ...
  hideApplication: 'Hide 思灵',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit 思灵',
  openApplication: 'Open 思灵',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit 思灵?',
  ...
  startupFailed: '思灵 is unavailable',
  ...
  restartBackendMenu: 'Restart DSH kernel',
  trayMaskMenu: 'Screen mask (show / release)',
  trayContrastMenu: 'Contrast mode (show DSH as-is)',
  // 崩溃恢复用的写操作：备份并清空 profile patch，恢复要人工处理。
  disableThirdPartyPlugins: 'Disable third-party plugins, back up profile patch, and restart',
  // 托盘用的只读操作：下次启动少加载第三方层，不碰任何数据。两者语义不同，故分开措辞。
  restartInSafeMode: 'Restart in safe mode (no third-party plugins; data untouched)',
  welcomeTitle: '思灵',
  welcomeBrand: '思灵',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: '思灵',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: '思灵 v{version} downloaded',
  ...
  updateTitle: '思灵 Update',
  updateAvailable: 'An update is available',
  updateDetail: '思灵 {version}\n\n思灵 will restart to complete the update.',
...
export const zh = {
  ...
  hideApplication: '隐藏 思灵',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 思灵',
  openApplication: '打开 思灵',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 思灵？',
  ...
  restartBackendMenu: '重启 DSH 内核',
  trayMaskMenu: '屏幕遮罩（显示 / 解除）',
  trayContrastMenu: '对照模式（看 DSH 原样）',
  // 崩溃恢复用的写操作：备份并清空 profile patch，恢复要人工处理。
  disableThirdPartyPlugins: '禁用第三方插件、备份 profile patch 并重启',
  // 托盘用的只读操作：下次启动少加载第三方层，不碰任何数据。两者语义不同，故分开措辞。
  restartInSafeMode: '以纯净模式重启（不加载第三方插件，数据不动）',
  welcomeTitle: '思灵',
  welcomeBrand: '思灵',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: '思灵 v{version} 下载完成',
